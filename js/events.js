...
const eventsData =  [
    {
      id: 1,
      title: "Taller de Pintura Moderna",
      subtitle: "Exprésate con colores y nuevas amistades",
      description: "Descubre tu lado artístico con un taller relajado al aire libre, ideal para principiantes o apasionados del arte.",
      meetingpoint: "Playa de la Barceloneta, zona del espigón. Recibirás la ubicación exacta por email tras inscribirte.",
      toBring: "Algo para sentarte (manta, cojín, etc.). Bebida o snack para compartir (opcional). ¡Ganas de pasarlo bien!",
      bestOfPlan: "Gente auténtica con ganas de desconectar. Ambiente acogedor con mantas y luces. Dinámicas para romper el hielo. La oportunidad perfecta para hacer nuevos amigos.",
    ...
    },
    {
      ...
      description: "Una experiencia revitalizante combinando senderismo en plena naturaleza y una sesión de yoga guiada al amanecer.",
      meetingpoint: "Entrada del Parque Natural de Collserola. Recibirás coordenadas exactas tras inscribirte.",
      toBring: "Ropa cómoda, agua, esterilla de yoga y ganas de conectar con la naturaleza.",
      bestOfPlan: "Paisajes increíbles, conexión cuerpo-mente, energía positiva y grupo reducido para una experiencia íntima.",
    ...
    },
    {
      ...
      description: "Proyección de una película indie seguida de un coloquio distendido con cervezas artesanas.",
      meetingpoint: "Bar cultural 'La Fábrica', sala del fondo.",
      toBring: "Curiosidad, ideas para compartir y ganas de debatir sin prejuicios.",
      bestOfPlan: "Ambiente relajado, nuevas perspectivas, buena conversación y cinéfilos con alma crítica.",
    ...
    },
    {
      ...
      description: "Ruta por la ciudad centrada en capturar retratos urbanos, seguida de picoteo para compartir resultados.",
      meetingpoint: "Plaza del MACBA. Busca al grupo con cámaras.",
      toBring: "Cámara o móvil con buena lente, ropa cómoda y algo para compartir en el picnic.",
      bestOfPlan: "Creatividad callejera, feedback fotográfico entre iguales, ambiente divertido y aprendizaje continuo.",
    ...
    },
    {
      ...
      description: "Juego de pistas por la ciudad con un toque de misterio y desafíos mentales, perfecto para romper el hielo.",
      meetingpoint: "Puerta principal del CCCB. Te enviaremos pistas por WhatsApp.",
      toBring: "Zapatos cómodos, móvil cargado y espíritu competitivo.",
      bestOfPlan: "Trabajo en equipo con desconocidos, mucha risa y sorpresas inesperadas por las calles de la ciudad.",
    ...
    },
    {
      ...
      description: "Encuentro social en un local con variedad de juegos, tapas compartidas y dinámicas para conocerse.",
      meetingpoint: "Te enviaremos la dirección exacta tras confirmar asistencia.",
      toBring: "Tu juego favorito (opcional), bebida o tapa y buena vibra.",
      bestOfPlan: "Ambiente cercano, ideal para los más tímidos, risas aseguradas y cero presión.",
    ...
    },
    {
      ...
      description: "Lecturas que provocan y remueven, con debates en cafés tranquilos entre gente con inquietudes.",
      meetingpoint: "Café 'Lento y Rico', mesa del fondo.",
      toBring: "El libro leído, mente abierta y respeto por otras opiniones.",
      bestOfPlan: "Intercambio de ideas, profundidad sin rigidez y posibilidad de nuevos amigos lectores.",
    ...
    },
    {
      ...
      description: "Un espectáculo de impro seguido de un taller interactivo para soltarse y reír en grupo.",
      meetingpoint: "Teatro Espontáneo, sala B.",
      toBring: "Ropa cómoda, ganas de reír y de hacer el ridículo (un poco).",
      bestOfPlan: "Desinhibición, conexión inmediata con desconocidos, subidón de energía.",
    ...
    },
    {
      ...
      description: "Acción solidaria de pocas horas seguida de vermut en grupo para compartir experiencias.",
      meetingpoint: "Entrada del banco de alimentos del barrio.",
      toBring: "Manos listas para ayudar y muchas ganas de conocer gente generosa.",
      bestOfPlan: "Conexión desde el corazón, impacto positivo y charla amena después de hacer algo bueno.",
    ...
    },
    {
      ...
      description: "Tour alternativo para descubrir arte urbano y acabar en un bar con buena vibra.",
      meetingpoint: "Metro Poblenou, salida Rambla.",
      toBring: "Móvil o cámara, ropa cómoda y curiosidad artística.",
      bestOfPlan: "Historias sorprendentes, arte en cada esquina y conversaciones espontáneas en cada parada.",
    ...
    },
    {
      ...
      description: "Karaoke temático con dinámicas para perder la vergüenza y pasarlo bien desde la primera canción.",
    ...
    },
    {
      ...
      description: "Taller relajado donde crear arte en papel mientras compartes merienda con otros creativos.",
    ...
    },
    {
      ...
      description: "Navega en grupo por la costa y termina compartiendo un picnic viendo la puesta de sol.",
      meetingpoint: "Puerto de Badalona, zona de embarque.",
      toBring: "Ropa de baño, toalla, protector solar y algo para el picnic.",
      bestOfPlan: "Conexión con la naturaleza, deporte y una puesta de sol épica en grupo.",
    ...
    },
    {
      ...
      description: "Conecta con locales e internacionales a través de dinámicas lingüísticas divertidas.",
      meetingpoint: "Terraza del hostal MundoMundo.",
      "¿Qué traer?": "Tu mejor sonrisa y curiosidad por otros acentos.",
      "Lo mejor de este plan": "Cero clases aburridas, mucha risa, conexiones interculturales y potenciales planes futuros.",
    ...
    },
    {
      ...
      description: "Recorrido por restaurantes de distintas culturas con paradas para compartir impresiones y anécdotas.",
      meetingpoint: "Plaza Universitat, punto de encuentro gastronómico.",
      toBring: "Apetito, curiosidad culinaria y conversación fácil.",
      bestOfPlan: "Cocinas del mundo, conversaciones entre bocado y bocado, y gente abierta.",
...
filtersButtons.forEach((button) => {
    button.addEventListener('click', () => {
        ...
        if(selectedFilters.includes(filterType)){
            selectedFilters = selectedFilters.filter(filter => filter !== filterType);
        } else {
...
function renderEventsCards() {
    const eventsFiltered = selectedFilters.length > 0 ? 
    eventsData.filter((event) => selectedFilters.includes(event.category))
    : eventsData
